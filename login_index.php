    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="myNavbar">
        ...
        <ul class="nav navbar-nav navbar-right">
          <li><a href="#"><span class="glyphicon glyphicon-user" style="color: #5e5240;"> Hello <?php echo($firstname); ?></span></a></li>
          <li><a href="add_cart1.php"><span class="glyphicon glyphicon-shopping-cart" style="color:#5e5240;"> Cart</span> </a></li>
          <li><a href="login_index.php?logout=true"><span class="glyphicon" style="color: #5e5240;"> Logout </span></a></li>
        </ul>
